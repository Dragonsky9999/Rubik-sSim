...
export class Cube {
    ...
    applyMove(moveName){
        ...
        const corner = applyPermutationWithOrientation(this.state.CP, this.state.CO, move.CP, move.CO, 3);
        const edge = applyPermutationWithOrientation(this.state.EP, this.state.EO, move.EP, move.EO, 2);
