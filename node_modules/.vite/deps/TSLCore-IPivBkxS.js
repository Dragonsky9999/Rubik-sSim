//#region node_modules/three/src/nodes/core/constants.js
/**
...
//#endregion
//#region node_modules/three/src/math/ColorManagement.js
...
//#endregion
//#region node_modules/three/src/math/Matrix2.js
/**
...
//#endregion
//#region node_modules/three/src/math/Matrix4.js
/**
...
//#endregion
//#region node_modules/three/src/math/Vector2.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/core/StackTrace.js
var IGNORED_FILES = [
	/^StackTrace\.js$/,
	/^TSLCore\.js$/,
	/^.*Node\.js$/,
...
//#endregion
//#region node_modules/three/src/nodes/core/NodeUtils.js
...
//#endregion
//#region node_modules/three/src/core/EventDispatcher.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/core/Node.js
...
//#endregion
//#region node_modules/three/src/nodes/utils/ArrayElementNode.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/utils/ConvertNode.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/core/TempNode.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/utils/JoinNode.js
/**
* This module is part of the TSL core and usually not used in app level code.
...
//#endregion
//#region node_modules/three/src/nodes/utils/SplitNode.js
...
var SplitNode = class extends Node {
	...
	*/
	getVectorLength() {
		...
		for (const c of this.components) vectorLength = Math.max(vectorComponents.indexOf(c) + 1, vectorLength);
		return vectorLength;
	}
	/**
...
//#endregion
//#region node_modules/three/src/nodes/utils/SetNode.js
/**
* This module is part of the TSL core and usually not used in app level code.
...
//#endregion
//#region node_modules/three/src/nodes/utils/FlipNode.js
/**
* This module is part of the TSL core and usually not used in app level code.
...
//#endregion
//#region node_modules/three/src/nodes/core/InputNode.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/core/ConstNode.js
...
//#endregion
//#region node_modules/three/src/nodes/utils/MemberNode.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/tsl/TSLCore.js
...
var ShaderNodeObject = function(obj, altType = null) {
	...
	else if (type === "shader") return obj.isFn ? obj : Fn(obj);
	return obj;
};
...
var ShaderCallNodeInternal = class extends Node {
	...
	call(builder) {
		...
		if (shaderNode.layout) {
			...
			result = nodeObject(hasParameters || jsFunc.length > 1 ? jsFunc(inputs, secureNodeBuilder) : jsFunc(secureNodeBuilder));
		}
...
var ConvertType = function(type, cacheMap = null) {
	return (...params) => {
		...
		if (params.length === 1 && cacheMap !== null && cacheMap.has(params[0])) return nodeObjectIntent(cacheMap.get(params[0]));
		if (params.length === 1) {
			const node = getConstNode(params[0], type);
			if (node.nodeType === type) return nodeObjectIntent(node);
			return nodeObjectIntent(new ConvertNode(node, type));
		}
		return nodeObjectIntent(new JoinNode(params.map((param) => getConstNode(param)), type));
	};
};
...
var nodeObject = (val, altType = null) => ShaderNodeObject(val, altType);
var nodeObjectIntent = (val, altType = null) => nodeObject(val, altType).toVarIntent();
...
var nodeProxyIntent = (NodeClass, scope = null, factor = null, settings = {}) => new ShaderNodeProxy(NodeClass, scope, factor, {
	...settings,
	intent: true
});
var fnId = 0;
...
var split = (node, channels) => new SplitNode(nodeObject(node), channels);
...
//#endregion
export { Vector2 as $, nodeObjectIntent as A, uvec4 as B, ivec4 as C, nodeArray as D, mat4 as E, split as F, TempNode as G, vec3 as H, string as I, EventDispatcher as J, ArrayElementNode as K, uint as L, nodeProxy as M, nodeProxyIntent as N, nodeImmutable as O, setCurrentStack as P, StackTrace as Q, uvec2 as R, ivec3 as S, mat3 as T, vec4 as U, vec2 as V, InputNode as W, hash as X, getValueFromType as Y, hashString as Z, float as _, vectorComponents as _t, Switch as a, normalize as at, int as b, arrayBuffer as c, warn as ct, bvec3 as d, SRGBTransfer as dt, Vector3 as et, bvec4 as f, StaticDrawUsage as ft, element as g, NodeUpdateType as gt, defined as h, NodeShaderStage as ht, Stack as i, generateUUID as it, nodeObjects as j, nodeObject as k, bool as l, warnOnce as lt, convert as m, WebGPUCoordinateSystem as mt, If as n, Matrix3 as nt, addMethodChaining as o, error as ot, color as p, WebGLCoordinateSystem as pt, Node as q, ShaderNode as r, denormalize as rt, append as s, log as st, Fn as t, ColorManagement as tt, bvec2 as u, FloatType as ut, getConstNodeType as v, mat2 as w, ivec2 as x, getCurrentStack as y, uvec3 as z };

//# sourceMappingURL=TSLCore-IPivBkxS.js.map